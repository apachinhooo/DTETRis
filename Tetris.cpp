...
int main()
{
    ...
    MenuItems mi;
    Texture t;
    t.loadFromFile("C:\\Users\\НИКИТА\\Downloads\\MAINCART.png");
    mi.menuSprite.setTexture(t);
    Texture t2;
    t2.loadFromFile("C:\\Users\\НИКИТА\\Downloads\\backfont.png");
    mi.gameSprite.setTexture(t2);
    
    Texture t3;
    t3.loadFromFile("C:\\Users\\НИКИТА\\Downloads\\results.png");
    ...
    Font font;
    font.loadFromFile("C:\\Users\\НИКИТА\\Desktop\\PakenhamBlItalic.ttf");
    ...
    srand(time(0));
    Texture t1;
    t1.loadFromFile("C:\\Users\\НИКИТА\\Downloads\\tiles.png");
    Sprite tiles(t1);
